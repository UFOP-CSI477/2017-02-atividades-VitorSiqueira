...
<html lang="pt-br">
    <head>
        ...
        <title>Atividade 16 - Laravel: Estrutura - Model e Controller (resource)</title>
    </head>
    <body>
        <div class="container">
            <header>
            ...
            <main>
                <h1 class="titulo">Atividade 16 - Laravel: Estrutura - Model e Controller (resource) - 25/01/2018</h1>
                <div class="container-fluid atividade">
                    <div class="well-lg" style="background-color: white;color: red;">Não Realizado.</div>
                    <br>
                    <a class="btn btn-default" href="../atividade15/index.php">Voltar</a>
                    <a class="btn btn-default" href="../index.html">Avançar</a>
                </div>
            </main>
            <footer>
