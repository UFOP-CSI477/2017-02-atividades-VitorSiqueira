...
<html lang="pt-br">
    <head>
        ...
        <title>Atividade 15 - Laravel: definir o layout/template principal (CSS/Bootstrap, AdminLTE)</title>
    </head>
    <body>
        <div class="container">
            <header>
            ...
            <main>
                <h1 class="titulo">Atividade 15 - Laravel: definir o layout/template principal (CSS/Bootstrap, AdminLTE) - 25/01/2018</h1>
                <div class="container-fluid atividade">
                    <div class="well-lg" style="background-color: white;color: red;">Não Realizado.</div>
                    <br>
                    <a class="btn btn-default" href="../atividade14/index.php">Voltar</a>
                    <a class="btn btn-default" href="../atividade16/index.php">Avançar</a>
                </div>
            </main>
            <footer>
