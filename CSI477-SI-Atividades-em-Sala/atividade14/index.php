...
<html lang="pt-br">
    <head>
        ...
        <title>Atividade 14 - PHP: MVC - lista de alunos, estados e cidades - apresentação em tabela/Bootstrap</title>
    </head>
    <body>
        <div class="container">
            <header>
            ...
            <main>
                <h1 class="titulo">Atividade 14 - PHP: MVC - lista de alunos, estados e cidades - apresentação em tabela/Bootstrap - 18/01/2018</h1>
                <div class="container-fluid atividade">
                    <div class="well-lg" style="background-color: white;color: red;">Não Realizado.</div>
                    <br>
                    <a class="btn btn-default" href="../atividade13/index.php">Voltar</a>
                    <a class="btn btn-default" href="../atividade15/index.php">Avançar</a>
                </div>
            </main>
            <footer>
